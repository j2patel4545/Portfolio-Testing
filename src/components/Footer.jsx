    ...
    return (
        <div className="flex justify-center items-center bg-white gap-4 py-8">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="https://github.com/j2patel4545/"  target='blank'>
                    <div class="social-button">
                        <button class="relative w-12 h-12 rounded-full group">
                            <div
                ...
                <a href="https://www.linkedin.com/in/j2keys/"  target='blank'>
                    <div class="social-button">
                        <button class="relative w-12 h-12 rounded-full group">
                            <div
                ...
                <a href="mailto:j2patel4545@gmail.com?subject=Mail throgh portfolio=This%20is%20a%20test%20email."  target='blank'>
                    <div class="social-button">
                        <button class="relative w-12 h-12 rounded-full group">
                            <div
